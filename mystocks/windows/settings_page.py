...
from mystocks.entities.classes import CURRENCIES
from mystocks.models.controller import SettingsModelController
from mystocks.settings import PORTFOLIO_TABLE_AMOUNT_COLUMN_NAMES
from mystocks.slots.receivers import add_settings_slot
from mystocks.widgets.messages import show_error_message, show_success_message

if TYPE_CHECKING:
    from PySide6.QtWidgets import QLineEdit

    from mystocks.windows.main import MainWindow
    from mystocks.windows.ui_interface import Ui_MainWindow
